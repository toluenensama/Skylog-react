...
export function Footer() {
  return (
    <footer className="py-12  border-t  flex justify-between items-center mt-12 pt-8 px-4 flex-wrap bg-gray-700/30 backdrop-blur-md border">
      ...
      <a
        href="#hero"
        className="bg-primary/20 p-2 rounded-full transition-colors duration-300 hover:bg-primary/40 "
      >
